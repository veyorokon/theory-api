...
class ArtifactAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Identity", {"fields": ("id", "world", "uri", "path")}),
        ("Type", {"fields": ("is_scalar", "content_type")}),
        ("Data", {"fields": ("data",), "description": "Only populated for scalar artifacts"}),
        ("Metadata", {"fields": ("size_bytes", "etag", "sha256", "created_at")}),
    )
