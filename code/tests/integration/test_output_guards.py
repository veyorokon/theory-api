...
""")
    ...
    def test_output_collision_prevention(self):
        ...
        cmd_base = [
            ...
            "--ref", "llm/litellm@1",
            "--adapter", "local",
            "--write-prefix", "/artifacts/outputs/collision-test/{execution_id}/",
            "--inputs-json", '{"messages":[{"role":"user","content":"collision test"}]}',
            "--json"
        ]
    ...
    def test_overwrite_protection(self):
        ...
        cmd = [
            ...
            "--ref", "llm/litellm@1", 
            "--adapter", "local",
            "--write-prefix", "/artifacts/outputs/overwrite-test/{execution_id}/",
            "--inputs-json", '{"messages":[{"role":"user","content":"overwrite test"}]}',
            "--json"
        ]
    ...
    def test_reserved_filename_protection(self):
        ...
        cmd = [
            ...
            "--ref", "llm/litellm@1",
            "--adapter", "local", 
            "--write-prefix", "/artifacts/outputs/reserved-test/{execution_id}/",
            "--inputs-json", '{"messages":[{"role":"user","content":"reserved test"}]}',
            "--json"
        ]
    ...
    def test_path_sanitization(self):
        ...
        cmd = [
            ...
            "--ref", "llm/litellm@1",
            "--adapter", "local",
            "--write-prefix", "/artifacts/outputs/sanitize-test/{execution_id}/",
            "--inputs-json", '{"messages":[{"role":"user","content":"path test"}]}',
            "--json"
        ]
