...
class TestImagePinning:
    ...
    def test_modal_requires_pinned_digest(self):
        ...
        spec_latest = {"image": {"oci": "ghcr.io/veyorokon/llm-litellm:latest"}}
        ...
        spec_branch = {"image": {"oci": "ghcr.io/veyorokon/llm-litellm:main"}}
    ...
    def test_modal_accepts_pinned_digest(self):
        ...
        spec_pinned = {
            "image": {
                "oci": "ghcr.io/veyorokon/llm-litellm@sha256:b0b2041c6b427649230b9afc6ac8e5aae6fbfdbf5bd5bc5d5192dc61260ad039"
            }
        }
